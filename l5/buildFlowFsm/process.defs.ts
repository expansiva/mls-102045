/// <mls fileReference="_102045_/l5/buildFlowFsm/process.defs.ts" enhancement="_blank"/>
...
export const buildFlowFsmProcess = {
  ...
  "runs": [
    {
      "runId": "ns-1785474264813",
      "kind": "newSolution-behavior",
      "startedAt": "2026-07-31T05:04:24.810Z",
      "finishedAt": "2026-07-31T05:04:24.813Z",
      "sourceRefs": {
        "module": "l4/buildFlowFsm/module.defs.ts",
        "health": "l4/buildFlowFsm/trace/behavior-health-report.json",
        "journeys": "l4/buildFlowFsm/siteMap.defs.ts",
