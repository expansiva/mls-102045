/// <mls fileReference="_102045_/l1/buildFlowFsm/layer_1_external/adapters/persistence/timeLog.ts" enhancement="_blank"/>
...
export const timeLogTableDef: TableDefinition = {
  ...
  tableName: 'time_log',
  purpose: 'controle',
  description: 'Apontamentos de horas (append-only). Campos não indexados em details (JSONB).',
  backupHot: false,
