/// <mls fileReference="_102045_/l1/buildFlowFsm/layer_1_external/adapters/persistence/statusReport.ts" enhancement="_blank"/>
...
export const statusReportTableDef: TableDefinition = {
  ...
  purpose: 'transacao',
  description:
    'Status reports for projects. Non-indexed fields and embedded delay risk suggestions stored in details (JSONB).',
  backupHot: false,
