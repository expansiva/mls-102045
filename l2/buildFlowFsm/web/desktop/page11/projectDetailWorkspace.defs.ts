...
export const definition = {
  ...
  "sections": [
    {
      "id": "section.projectDetailWorkspace.sec-projectHeader",
      "type": "section",
      "sectionName": "Project Header",
      "titleKey": "section.projectDetailWorkspace.sec-projectHeader.title",
      "mode": "view",
      "order": 10,
      "organisms": [
        {
          "id": "org-projectDetailPanel",
          "type": "queryResult",
          "organismName": "ProjectDetailPanel",
          "titleKey": "organism.projectDetailWorkspace.getProjectDetail.title",
          "purpose": "Displays the full project record — client, site address, schedule dates, budget, and current lifecycle status — as the authoritative anchor for all downstream analysis on this page.",
          "userActions": [
            "getProjectDetail"
          ],
          "requiredEntities": [],
    ...
    {
      "id": "section.projectDetailWorkspace.sec-taskTimeline",
      "type": "section",
      "sectionName": "Work Tasks & Timeline",
      "titleKey": "section.projectDetailWorkspace.sec-taskTimeline.title",
      "mode": "view",
      "order": 20,
      "organisms": [
        {
          "id": "org-workTasksBoard",
          "type": "queryResult",
          "organismName": "WorkTasksBoard",
          "titleKey": "organism.projectDetailWorkspace.listWorkTasks.title",
          "purpose": "Lists all work tasks for this project with status, assignee, due date, and overdue indicators, with inline filters for status and assigned worker so the PM can quickly spot blockers.",
          "userActions": [
            "listWorkTasks"
          ],
          "requiredEntities": [],
    ...
    {
      "id": "section.projectDetailWorkspace.sec-changeOrders",
      "type": "section",
      "sectionName": "Change Orders",
      "titleKey": "section.projectDetailWorkspace.sec-changeOrders.title",
      "mode": "view",
      "order": 30,
      "organisms": [
        {
          "id": "org-changeOrdersList",
          "type": "queryResult",
          "organismName": "ChangeOrdersList",
          "titleKey": "organism.projectDetailWorkspace.listChangeOrders.title",
          "purpose": "Browses all change orders for this project, filterable by status and impact type, so the PM can track cost and schedule exposure at a glance.",
          "userActions": [
            "listChangeOrders"
          ],
          "requiredEntities": [],
        ...
        {
          "id": "org-changeOrderDetailPanel",
          "type": "queryResult",
          "organismName": "ChangeOrderDetailPanel",
          "titleKey": "organism.projectDetailWorkspace.getChangeOrderDetail.title",
          "purpose": "Shows the full detail of the selected change order — title, description, impact type, cost adjustment, schedule adjustment days, approval status, and comparison against project budget — so the PM can assess financial consequence.",
          "userActions": [
    ...
    {
      "id": "section.projectDetailWorkspace.sec-costTracking",
      "type": "section",
      "sectionName": "Cost Tracking — Time Logs",
      "titleKey": "section.projectDetailWorkspace.sec-costTracking.title",
      "mode": "view",
      "order": 40,
      "organisms": [
        {
          "id": "org-timeLogsTable",
          "type": "queryResult",
          "organismName": "TimeLogsTable",
          "titleKey": "organism.projectDetailWorkspace.listTimeLogs.title",
          "purpose": "Lists time log entries filterable by work task, worker name, log date, and status so the PM can review labor hours and costs incurred on the project.",
          "userActions": [
            "listTimeLogs"
          ],
          "requiredEntities": [],
    ...
    {
      "id": "section.projectDetailWorkspace.sec-materialUsage",
      "type": "section",
      "sectionName": "Material Usage",
      "titleKey": "section.projectDetailWorkspace.sec-materialUsage.title",
      "mode": "view",
      "order": 50,
      "organisms": [
        {
          "id": "org-materialUsageTable",
          "type": "queryResult",
          "organismName": "MaterialUsageTable",
          "titleKey": "organism.projectDetailWorkspace.listMaterialUsages.title",
          "purpose": "Lists material usage entries for this project filterable by status, showing material name, quantity, unit cost, cost code, and usage date so the PM can track material expenditure.",
          "userActions": [
            "listMaterialUsages"
          ],
          "requiredEntities": [],
    ...
    {
      "id": "section.projectDetailWorkspace.sec-delayRiskInsights",
      "type": "section",
      "sectionName": "Delay Risk Insights",
      "titleKey": "section.projectDetailWorkspace.sec-delayRiskInsights.title",
      "mode": "edit",
      "order": 60,
      "organisms": [
        {
          "id": "org-delayRiskTrigger",
          "type": "commandForm",
          "organismName": "DelayRiskTriggerAction",
          "titleKey": "organism.projectDetailWorkspace.triggerDelayRiskSuggestions.title",
          "purpose": "Provides the 'Generate Delay-Risk Suggestions' command scoped to the current status report, allowing the PM to initiate AI analysis of task progress and flag at-risk items.",
          "userActions": [
        ...
        {
          "id": "org-delayRiskSuggestionsList",
          "type": "queryResult",
          "organismName": "DelayRiskSuggestionsList",
          "titleKey": "organism.projectDetailWorkspace.listDelayRiskSuggestions.title",
          "purpose": "Displays AI-generated delay-risk suggestions linked to the selected status report, showing risk level, reason, related work task, and recommended action so the PM can review and acknowledge each advisory item.",
          "userActions": [
