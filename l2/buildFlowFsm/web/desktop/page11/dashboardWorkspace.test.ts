/// <mls fileReference="_102045_/l2/buildFlowFsm/web/desktop/page11/dashboardWorkspace.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "cases": [
    {
      "id": "getDashboardSummary.ok",
      "routine": "buildFlowFsm.dashboardWorkspace.getDashboardSummary",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "paginated",
    ...
    {
      "id": "getProjectList.ok",
      "routine": "buildFlowFsm.dashboardWorkspace.getProjectList",
      "params": {},
      "expect": {
        "ok": true,
        "shape": "paginated",
