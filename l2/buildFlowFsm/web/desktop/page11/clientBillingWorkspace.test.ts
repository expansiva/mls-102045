/// <mls fileReference="_102045_/l2/buildFlowFsm/web/desktop/page11/clientBillingWorkspace.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "clientBillingWorkspace",
  "variant": "page11",
  "actor": "client",
  "cases": [
    {
      "id": "getBillingSummary.ok",
      "routine": "buildFlowFsm.clientBillingWorkspace.getBillingSummary",
      "params": {
    ...
    {
      "id": "getInvoice.ok",
      "routine": "buildFlowFsm.clientBillingWorkspace.getInvoice",
      "params": {
        "invoiceId": "<seedRef>"
      },
      "expect": {
