/// <mls fileReference="_102045_/l2/buildFlowFsm/web/desktop/page11/jobCostWorkspace.test.ts" enhancement="_blank"/>
...
export const pageTests = {
  ...
  "page": "jobCostWorkspace",
  "variant": "page11",
  "actor": "billingStaff",
  "cases": [
    {
      "id": "viewJobCostSummary.ok",
      "routine": "buildFlowFsm.jobCostWorkspace.viewJobCostSummary",
      "params": {
        "projectId": "<seedRef>"
      },
      "expect": {
